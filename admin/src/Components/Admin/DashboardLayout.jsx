    ...
    <div className="dashboard-layout flex flex-col">
      ...
      {isLoggedIn
        ...
        <div className="w-full h-32">
          <aside className={`fixed h-screen sidebar bg-gray-800 text-gray-300 p-4 transition-all duration-300 ${isSidebarOpen ? 'w-64' : 'w-16'}`}>
            <nav>
          ...
          <main className={`w-full h-full main-content bg-gray-100  ${isSidebarOpen ? 'pl-64' : 'pl-16'}`}>
            <Outlet />
          </main>
        </div>
      }
