...
const fetchCustomers = async ({ queryKey }) => {
    ...
    const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/api/v1/customer/list`, { params: { page, limit } });
    return data;
};
...
function CustomerManagement() {
    ...
    const handleAddCustomer = async (newCustomer) => {
        try {
            ...
            const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/v1/customer/add`, newCustomer);
